            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a href="{{ route('admin.menus.index') }}" class="nav-link">Menus</a></li>
                        <li class="nav-item"><a href="{{ route('admin.tables.index') }}" class="nav-link">Tables</a>
                        </li>
                        <li class="nav-item"><a href="{{ route('admin.reservations.index') }}"
